...
<head>
    ...
    <!-- Ionicons -->
    <link rel="stylesheet" href="{{ asset('panel/dist/sweetalert.css') }}">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{ asset('panel/avatar.jpg') }}" class="user-image" alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="{{ asset('panel/avatar.jpg') }}" class="img-circle" alt="User Image">
                                <p>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/forum"><i class="fa fa-circle-o"></i> Forum Başlıkları</a></li>
                        <li><a href="/admin/sub-forum"><i class="fa fa-circle-o"></i> Forum Alt Başlıkları</a></li>
                        <li><a href="/admin/forum-topics"><i class="fa fa-circle-o"></i> Forum Konuları</a></li>
                        <li><a href="/admin/forum-posts"><i class="fa fa-circle-o"></i> Forum Gönderileri</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="/logout">
...
<script src="{{ asset('panel/plugins/select2/select2.full.min.js') }}"></script>
<script>
    $(function () {
